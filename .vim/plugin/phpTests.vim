...
if !exists('g:phpUnit')
    let g:phpUnit = $HOME . g:phpUnitBinFile
endif
let s:outputLineContinue = '> '
let g:testOutputBufferName = 'TestOutput'

function! phpTests#setConfigOptions()
...
if !exists('g:phpTestsOptions') 
    call phpTests#setConfigOptions()
endif

function! phpTests#togglePhpUnitConfig(unitConfig, type)
    let g:phpUnit = $HOME . a:unitConfig
    let g:phpTestType = $HOME . a:type
    call phpTests#setConfigOptions()
endfunction
